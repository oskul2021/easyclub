...
export default function NavBar(props: any) {
  ...
  const [showDonationImports, setShowDonationImports] = useState(false);
      ...
      <Navbar bg="dark" variant="dark">
        <Container className="d-none d-sm-flex">
          ...
          <Nav className="me-auto">
            ...
            {showDonationImports && <Nav.Link href="/donationImport">Import Donations</Nav.Link>}
          </Nav>
          <Nav>
            {showLogout && (
