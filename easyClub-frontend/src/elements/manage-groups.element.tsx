...
import ModalCreateGroup from "./administration/groups/modal-create-group.element";
import ModalEditGroup from "./administration/groups/modal-edit-group.element";
import ModalAddUserToGroup from "./administration/groups/modal-add-user-to-group.element";
...
export default function ManageGroups(props: any) {
  ...
  const handleCloseAddUserToGroupModal = (e: any) => {
    setShowAddUserToGroupModal(false);
    if (e) setGroups(e);
  };
  const handleShowAddUserToGroupModal = (e: any) => {
    setGroup(e);
  ...
  const removeUser = (eUser: any, eGroup: any) => {
